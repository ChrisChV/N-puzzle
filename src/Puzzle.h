...
void Puzzle::Resolver(){
    ...
    if(t != -1){
        ...
        nextPorPaso();
        std::cout<<"RESUELTO"<<std::endl;
        std::cout<<"LARGO DE CAMINO->"<<camino.size()<<std::endl;
        std::cout<<"COMANDOS:"<<std::endl;
        std::cout<<"n  para ir al next"<<std::endl;
        std::cout<<"p  para ir al previus"<<std::endl;
        std::cout<<"r  para ver la animacion hasta el final"<<std::endl;
        std::cout<<"f  para ir al inicio del puzzle"<<std::endl;
        std::cout<<"e  para salir del programa"<<std::endl;
        char c;
        std::cin>>c;
        while(c != 'e'){
            switch(c){
                ...
                case 'f':
                    ...
                    break;
                default:
                    std::cout<<"Escriba alguno de los comandos"<<std::endl;
                    break;
            }
            std::cin>>c;
        }
...
void Puzzle::prev(){
    if(actual == camino.begin()){
        std::cout<<"Ya no existe previus"<<std::endl;
        return;
    }
